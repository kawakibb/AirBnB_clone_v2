...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """saving method and if it update"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """values in dict returned from to_dict testing"""
    ...
    def test_str(self):
        """ verify str method has the correct output"""
        amenity = Amenity()
